# Generated by Django 3.2.2 on 2024-04-04 16:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hours_close', models.TimeField(default=datetime.time(16, 14, 0, 839639), verbose_name='Hora de Cierre')),
                ('cash_sale', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Ventas en efectivo')),
                ('sale_card', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Ventas con tarjeta, yape o plin')),
                ('initial_box', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Caja inicial')),
                ('box_final', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Caja final total')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codebar', models.CharField(blank=True, max_length=20, null=True, verbose_name='Código')),
                ...
                ('unit', models.CharField(choices=[('unidad', 'Unidad'), ('kilogramo', 'Kilogramo')], default='unidad', max_length=20, verbose_name='Unidad de medida')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('payment_condition', models.CharField(choices=[('contado', 'Contado'), ('credito', 'Credito')], default='contado', max_length=50)),
                ('payment_method', models.CharField(choices=[('efectivo', 'Efectivo'), ('plin', 'Plin'), ('yape', 'Yape'), ('tarjeta_debito_credito', 'Tarjeta de Debito / Credito'), ('efectivo_tarjeta', 'Efectivo y Tarjeta')], default='efectivo', max_length=50)),
                ('type_voucher', models.CharField(choices=[('ticket', 'Ticket'), ('boleta', 'Boleta'), ('factura', 'Factura')], default='ticket', max_length=50)),
                ('date_joined', models.DateField(default=datetime.datetime.now)),
                ('end_credit', models.DateField(default=datetime.datetime.now)),
                ('subtotal', models.DecimalField(decimal_places=2, default=0.0, max_digits=9)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cant', models.DecimalField(decimal_places=3, default=0.0, max_digits=9)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cant', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('price', models.DecimalField(decimal_places=2, default=0.0, max_digits=9)),
                ('dscto', models.DecimalField(decimal_places=2, default=0.0, max_digits=9)),
                ('subtotal', models.DecimalField(decimal_places=2, default=0.0, max_digits=9)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='pos.product')),
